...
[handles.data.pos,handles.data.vec,handles.data.force,schrott1,schrott2,handles.data.f_mat] = reg_fourier_TFM(grid_mat,u,handles.data.young,handles.data.poisson, handles.data.pix_durch_my, handles.data.zdepth, handles.data.meshsize, i_max,j_max,handles.data.regparam);
...
for frame = 1:framenumber
    ...
    [TFM_results(frame).pos,TFM_results(frame).vec,TFM_results(frame).traction,TFM_results(frame).traction_magnitude,TFM_results(frame).energy] = reg_fourier_TFM(grid_mat,u,handles.data.young,handles.data.poisson, handles.data.pix_durch_my, handles.data.zdepth, handles.data.meshsize, i_max,j_max,handles.data.regparam);
end
